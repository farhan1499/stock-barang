...
<html lang="en">
    <head>
        ...
        <title>Barang Keluar - RCS Website</title>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            $alldatastock = mysqli_query( $conn, "SELECT * FROM keluar k, stock s WHERE s.idbarang = k.idbarang" );
        ...
        <div class="modal-header">
            ...
            <form method="post">
                    <div class="modal-body">
                        <select name="databarangkeluar" class="form-control">
                            <?php
