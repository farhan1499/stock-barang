...
<html lang="en">
    <head>
        ...
        <title>Barang Masuk - RCS Website</title>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            $alldatastock = mysqli_query( $conn, "SELECT * FROM masuk m, stock s WHERE s.idbarang = m.idbarang" );
        ...
        <div class="modal-header">
            ...
            <form method="post">
                    <div class="modal-body">
                        <select name="databarangmasuk" class="form-control">
                            <?php
                                $alldata = mysqli_query( $conn, "SELECT * FROM stock" );
                                while( $fetcharray = mysqli_fetch_array( $alldata )) {
                                    
                                    $namabarangmasuk = $fetcharray['namabarang'];
                                    $idbarangmasuk = $fetcharray['idbarang'];
                            ?>

                            <option value="<?=$idbarangmasuk?>"><?=$namabarangmasuk?></option>
                        ...
                        <br>
                        <input type="number" name="qty" placeholder="Jumlah Barang" class="form-control" required><br>
